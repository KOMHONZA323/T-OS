...
/* New UI Elements */
#define COLOR_ACTIVITIES_BTN 0xA0303030
#define COLOR_CLOCK_TEXT     0xFFFFFFFF
#define COLOR_TRAY_ICONS     0xFFDDDDDD
#define COLOR_START_BTN_BG   0x00000000
#define COLOR_APP_ICON_GLOW  0x4000E5FF
#define COLOR_SHOW_DESKTOP   0x80555555
#define COLOR_C_CODE_BG      0xFF1E1E1E
